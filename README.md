<div align="center">
  ...
  <h3 align="center">
Um sistema de gerenciamento de saúde</h3>

   <div align="center">
     Um sistema de gerenciamento de saúde que facilita o acompanhamento de pacientes, consultas e prontuários médicos. Ele permite o controle centralizado de informações de saúde, agendamento de consultas, emissão de relatórios, além de integrar dados de diversos profissionais da área, garantindo um atendimento mais eficiente e organizado.
    </div>
</div>
...
Um aplicativo de gerenciamento de pacientes de saúde que permite aos pacientes registrar, agendar e gerenciar facilmente suas consultas com médicos, apresentando ferramentas administrativas para agendar, confirmar e cancelar consultas, além de notificações por SMS, tudo criado em Next.js.
...
👉 Registrar-se como Paciente: Usuários podem se inscrever e criar um perfil pessoal como paciente.

👉 Agendar Nova Consulta com o Médico: Pacientes podem agendar consultas com médicos de acordo com sua conveniência e podem marcar várias consultas.

👉 Gerenciar Consultas no Lado Administrativo: Administradores podem visualizar e gerenciar eficientemente todas as consultas agendadas.

👉 Confirmar/Agendar Consulta pelo Administrador: Os administradores podem confirmar e definir horários de consultas para garantir que estejam devidamente agendadas.

👉 Cancelar Consulta pelo Administrador: Administradores têm a capacidade de cancelar qualquer consulta, se necessário.

👉 Enviar SMS na Confirmação da Consulta: Pacientes recebem notificações por SMS para confirmar os detalhes de suas consultas.

👉 Responsividade Completa: O aplicativo funciona perfeitamente em todos os tipos de dispositivos e tamanhos de tela.

👉 Upload de Arquivos Usando Appwrite Storage: Usuários podem enviar e armazenar arquivos com segurança no aplicativo usando os serviços de armazenamento Appwrite.

👉 Gerenciar e Acompanhar o Desempenho do Aplicativo Usando Sentry: O aplicativo usa o Sentry para monitorar e acompanhar seu desempenho, além de detectar erros.
...
```bash
git clone https://github.com/gabrielmina118/healtDashboard
cd healtDashboard
```
...
Substitua os valores do espaço reservado pelas suas credenciais reais do Appwrite. Você pode obter essas credenciais inscrevendo-se no [site Appwrite](https://appwrite.io/).
...
Abra [http://localhost:3000](http://localhost:3000) no sei browser para ver o projeto.
